...
var mapboxTiles = {
    accessToken: "pk.eyJ1IjoibWVseW5ndXkiLCJhIjoiY2l2bXB3MXZoMDAwMDJ5bXlpNDZwNHI4YyJ9.dVSk_CPrhenvGFUr1eKQNg",
...
function genMarkerPopup(record) {
    var html = "<h2>" + record.incident_number + "</h2>" + "<p>" + record.type + "</p>";
    return html;
}
